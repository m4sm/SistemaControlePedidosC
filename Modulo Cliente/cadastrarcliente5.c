        ...
        switch(strlen(p.cadastro)){
            case 11:
                ...
                if(!resultado){
                    ...
                    while(fgets(texto, sizeof(texto), fp)){
                        ...
                        sscanf(texto, "%s %s", p.cpf, cpf_existente);

                        if (strcmp(p.cpf, cpf_existente) == 0) {
                            existe_cpf = 1;
                            break;
                        }
                    }
            ...
            case 14:
                ...
                if(!resultadocnpj){
                    ...
                    while(fgets(texto, sizeof(texto), fp)){
                        char cnpj_existente[15];

                        //ler o codigo e o cnpj da linha
                        sscanf(texto, "%s %s", p.cnpj, cnpj_existente);

                        if (strcmp(p.cnpj, cnpj_existente) == 0) {
                            existe_cnpj = 1;
                            break;
                        }
                    }
