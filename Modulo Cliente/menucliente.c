...
void maincliente(){
    ...
    char *opcoes[] = {
        "Cadastrar Cliente", "Consultar Clientes", "Remover Clientes", "Listar Clientes", "Sair"
    };
    ...
    while(1){
        ...
        mvprintw(3,2, "Use as SETAS para navegar e ENTER  para selecionar");

        for(int i = 0; i < n_opcoes; i++){
            if(i == escolha){
                attron(A_REVERSE); //destaca a opçao atual
            }
